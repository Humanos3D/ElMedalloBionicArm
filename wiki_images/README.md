This directory stores images that we want to use in the wiki.  It is useful to store images here as we can upload them via the web and then refer to them directly in the wiki.
